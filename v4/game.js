...
serverUrl+=":"+port;}
this.socket=io(serverUrl,{withCredentials:false,transports:['websocket','polling']});if(this.socket){connecting=true;}}else{if(this.socket.disconnected){this.socket.connect();connecting=true;}}
